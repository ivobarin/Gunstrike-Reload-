...
class Menus:
    def __init__(self):
        self.state = 'Menu'
        self.img_menu = pygame.image.load(r"img\title.png")
        self.img_ranking = pygame.image.load(r"img\ranking.png")
        self.img_submit = pygame.image.load(r"img\submit.png")
        self.img_game_over = pygame.image.load(r"img\Game_Over.png")
        self.music = pygame.mixer.Sound('sounds\el_macho.ogg')
        self.scores = []
        self.score_final = 0 
        self.texto_score = 0
        self.flag_submit = False 
        self.flag_scores = False 
        self.font = pygame.font.Font("Westhorn-Regular.ttf", 40)
        self.input = ""
