...
# - Icono
pygame.display.set_icon(pygame.transform.scale(pygame.image.load("www/img/icono.jpg").convert(),(16,16)))

# - Imagenes 
img_cielo = pygame.transform.scale(pygame.image.load('www/img/sky.png').convert(),(1200,250))
img_piso = pygame.image.load('www/img/piso.png').convert()

# - Render
font = pygame.font.SysFont("pixellari",40,False,True)

# - Score 
img_score = pygame.transform.scale(pygame.image.load('www/img/Score.png'),(200,100))
...
img_timer = pygame.transform.scale(pygame.image.load('www/img/Timer.png'),(200,100))
...
covertura_1 = Cover('www/img/items/barrel.png',100,500,85,85)
covertura_2 = Cover('www/img/items/barrel.png',300,500,85,85)
covertura_3 = Cover('www/img/items/cactus-1.png',375,230,75,130)
covertura_4 = Cover('www/img/items/cactus-1.png',800,230,75,130)
covertura_5 = Cover(r'www/img\items\rock-4.png',1060,300,75,100)
covertura_6 = Cover(r'www/img\items\rock-5.png',1010,340,65,35)
covertura_7 = Cover('www/img/items/barrel.png',600,500,85,85)
covertura_8 = Cover('www/img/items/barrel.png',850,500,85,85)
...
while True:
    ...
    if menu_principal.estado_menu(pantalla):        
        ...
        if flag_new_enemies_lv1:
            enemigo1 = Enemy('www/img/enemies/cowboy/ranger.png',63,445)
            enemigo2 = Enemy('www/img/enemies/cowboy/ranger.png',263,445)
            enemigo3 = Enemy('www/img/enemies/cowboy/ranger.png',340,210)
            enemigo4 = Enemy('www/img/enemies/cowboy/ranger.png',770,210)
            enemigo5 = Enemy('www/img/enemies/cowboy/ranger.png',565,445)
            enemigo6 = Enemy('www/img/enemies/cowboy/ranger.png',815,445)
            enemies.add(enemigo1,enemigo2,enemigo3,enemigo4,enemigo5,enemigo6)
            flag_new_enemies_lv1 = False 
        
        # - nivel 2
        elif flag_new_enemies_lv2:
            enemigo1 = Enemy('www/img\enemies\cowboy\gunslinger.png',63,465)
            enemigo2 = Enemy('www/img\enemies\cowboy\gunslinger.png',263,465)
            enemigo3 = Enemy('www/img\enemies\cowboy\gunslinger.png',340,210)
            enemigo4 = Enemy('www/img\enemies\cowboy\gunslinger.png',770,210)
            enemigo5 = Enemy('www/img\enemies\cowboy\gunslinger.png',565,465)
            enemigo6 = Enemy('www/img\enemies\cowboy\gunslinger.png',815,465)
            enemigo7 = Enemy('www/img\enemies\cowboy\gunslinger.png',1015,275)
